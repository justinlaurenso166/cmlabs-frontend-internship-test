class Header extends HTMLElement {
    ...
    connectedCallback() {
        this.innerHTML = `
        <header class="header">
            <h1 class="font-bold text-xl sm:text-2xl tracking-wide hover:cursor-pointer" > <a href="./../index.html">MealApp</a></h1>
        ...
        <div class="relative">
            <div class="z-50 w-full absolute hidden bg-white shadow-md" id="menu-dropdown">
                <nav class="flex flex-col font-semibold text-lg">
                    <a href="./../index.html" class="py-3 text-center hover:bg-black hover:text-white transition-all delay-100 ease-in">Home</a>
